...
STATIC const COMP_KW_MAP kw_map[] = {
    ...
    {CTOK_KW_F32, "F32"}, {CTOK_KW_U0, "U0"}, {CTOK_KW_BOOL, "BOOL"}, {CTOK_KW_BOOL, "BOOLEAN"},
    {CTOK_KW_TRUE, "TRUE"}, {CTOK_KW_FALSE, "FALSE"}, {CTOK_KW_NULLPTR, "NULLPTR"}, {CTOK_KW_NULLPTR, "NULL"},
